        ...
        <div className="live-page-wrapper">
            <div className="live-page-container">
                ...
                <div className="live-page-content">
                    ...
                    {/* About section */}
                    {(user.pageAboutMe || user.pageSocialYouTube || user.pageSocialFacebook || user.pageSocialWhatsApp || user.pageSocialInstagram || user.pageSocialLinkedIn) && (
                        <div style={{ marginBottom: '48px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '20px', marginTop: '32px', flexWrap: 'wrap' }}>
                                ...
                                {user.pageSocialLinkedIn && (
                                    <a href={user.pageSocialLinkedIn} target="_blank" rel="noopener noreferrer" style={{ width: '48px', height: '48px', borderRadius: '50%', background: '#0077b5', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', transition: 'transform 0.2s', padding: '12px' }} className="social-icon">
