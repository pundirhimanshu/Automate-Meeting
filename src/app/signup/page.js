                ...
                <div className="auth-form-side">
                    <div className="auth-inner-form">
                        <div className="auth-card" style={{ textAlign: 'center' }}>
                            ...
                            <div style={{ padding: '20px', background: '#f0f9ff', borderRadius: '12px', fontSize: '0.875rem', color: '#0c4a6e', marginBottom: '24px', textAlign: 'left' }}>
                                <strong>Didn't receive the email?</strong><br />
                                Check your spam folder or wait a moment and try signing up again.
                            </div>
                            <Link href="/login" className="btn btn-primary btn-lg w-full" style={{ borderRadius: '10px', textDecoration: 'none', display: 'block', padding: '14px' }}>
                                Go to Login
                            </Link>
                        </div>
                    </div>
