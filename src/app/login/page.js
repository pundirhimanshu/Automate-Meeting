    ...
    return (
        <>
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .brand-tagline { font-size: 0.75rem; color: #666; font-weight: 500; }
                ...
                <div className="auth-image-side">
                    <div className="auth-image-container">
                        ...
                        <div className="halftone-content">
                            <h2 className="halftone-title">A community for planners to move faster and improve.</h2>
                            <p className="halftone-subtitle">Manage your time with precision—problem, constraints, and solution. Get focus directly on your productivity with smart scheduling.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="auth-container">
                        <div className="brand-header">
                            <div>
                                ...
                                <div className="brand-tagline">where time refine</div>
                            </div>
                        </div>

                        <h1 className="welcome-title">Welcome back</h1>
                        <p className="welcome-subtitle">Sign in with your Google account to manage your bookings and streamline your workflow.</p>

                        <button className="btn-google-premium" type="button" onClick={() => signIn('google', { callbackUrl: '/scheduling' })}>
                        ...
                        <form onSubmit={handleSubmit}>
                            {verified === 'true' && (
                                <div style={{ padding: '12px 14px', background: 'rgba(22, 101, 52, 0.1)', borderRadius: '8px', color: '#4ade80', fontSize: '0.8125rem', marginBottom: '16px', border: '1px solid rgba(22, 101, 52, 0.2)' }}>
                            ...
                            <div className="input-group-premium">
                                ...
                                <input id="email" type="email" className="input-premium" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                            </div>

                            <div className="input-group-premium">
                                <label htmlFor="password">Password</label>
                                <input id="password" type="password" className="input-premium" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                            </div>

                            <div style={{ textAlign: 'right', marginTop: '-12px' }}>
                                <Link href="/forgot-password" style={{ fontSize: '0.8125rem', color: '#888', textDecoration: 'none' }}>Forgot password?</Link>
                            </div>
                        ...
                        <div style={{ marginTop: '32px', textAlign: 'center', color: '#555', fontSize: '0.875rem' }}>
                            ...
                            <Link href="/signup" style={{ color: '#fff', fontWeight: 600, textDecoration: 'none' }}>Sign up for free</Link>
                        </div>
                    </div>
                </div>
            </div>
